    ...
    **/
    ...
    div (Complex z, double x, double y) {
        ...
        if (Math.abs(x) >= Math.abs(y)) {
			double yxratio = y/x;
            scalar =  1.0 / ( x + y*yxratio );

            zRe =  scalar * (z.re + z.im*yxratio);
            zIm =  scalar * (z.im - z.re*yxratio);

        } else {
			double xyratio = x/y;
            scalar =  1.0 / ( x*xyratio + y );

            zRe =  scalar * (z.re*xyratio + z.im);
            zIm =  scalar * (z.im*xyratio - z.re);
        }//endif
