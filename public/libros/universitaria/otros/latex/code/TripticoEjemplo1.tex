...
%\AddToBackground{1}{ % Fondo de una página pequeña
  %\put(0,0){\textcolor{Cerulean}{\rule{\paperwidth}{\paperheight}}}}

\AddToBackground{1}{ % Fondo de una página pequeña
  \put(10,450){\includegraphics[scale=0.5]{LogoCIEMAC}}}

\AddToBackground{6}{ % Fondo de una página pequeña
  \put(0,0){\textcolor{Cyan!50}{\rule{\paperwidth}{\paperheight}}}}

%\AddToBackground{6}{ % Fondo de una página pequeña
 % \put(10,450){\includegraphics[scale=1]{LogoTEC}}}
...
\AddToBackground*{1}{ % Fondo de una página grande
