...
%-------------------CONTENIDO -----------------------------------------------------
%\usepackage{kpfonts}
\definecolor{doc}{RGB}{166,206,58}
%\usepackage{titletoc}
\contentsmargin{0cm}
\titlecontents{chapter}[0pc]
{\addvspace{30pt}%
\begin{tikzpicture}[remember picture, overlay]%
\draw[fill=doc!80,draw=doc!80] (-4,-.1) rectangle (0.0,0.5);% rectángulo antes del "capítulo tal"
\pgftext[left,x=-1.5 cm,y=0.2cm]{\color{white}\Huge\sc\bfseries \ \thecontentslabel};%
\end{tikzpicture}\color{doc!80}\large\sc\bfseries}%
{}
{}
{\;\titlerule\;\large\sc\bfseries Página \thecontentspage
\begin{tikzpicture}[remember picture, overlay]
\draw[fill=doc!80,draw=doc!80] (2pt,0) rectangle (6,0.1pt);
\end{tikzpicture}}%
...
\vspace*{-20\p@}%
\begin{tikzpicture}[remember picture, overlay]%
\pgftext[right,x=15cm,y=0.2cm]{\color{doc!80}\Huge\sc\bfseries \contentsname};%
\draw[fill=doc!80,draw=doc!80] (13,-.75) rectangle (20,1);%
...
%----------------------------------------------------------------------------------------
 ...
 \titleformat{\chapter}[hang]{\huge\bfseries}{{
         ...
         \thechapter}\hsp\textcolor{verdep}{\vrule height 4em width 1pt}\hsp}{0pt}{\huge\bfseries}
