      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="text-gray-800 leading-relaxed font-alt text-justify space-y-10">
          ...
          <section>
            ...
            <p>
              La coordinación de arbitraje utiliza la herramienta de control de
              plagio (propuesta por la plataforma Tec-Digital del Instituto
              Tecnológico de Costa Rica que se basa en el paquete Turnitin para
              sus búsquedas) al recibir inicialmente la propuesta a evaluar. En
              caso de obtener más de un 25% de similitud, se comunica con el o
              los autores para que se aclare dicha coincidencia; en caso de
              persistir, se rechaza de inmediato la propuesta.
            </p>
            <p className="mt-3">
              ...
              >
                plagiarisma.net <TbExternalLink className="text-xs" />
              </a>{" "}
              o{" "}
              <a
                ...
                className="text-tec-blue-secondary hover:underline inline-flex items-center gap-1"
              >
                dustball.com <TbExternalLink className="text-xs" />
              </a>{" "}
          ...
          <section>
            ...
            <p>
              Se preservan los pdf y otros en el Departamento de Administración
              de Tecnologías de Información y Comunicaciones (Datic) del
              Instituto Tecnológico de Costa Rica, el cual brinda respaldos a
              toda la red de servidores virtuales que aloja la universidad.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">Las políticas éticas para la publicación son:</p>
            <ul className="list-disc list-outside pl-6 space-y-2 text-gray-700 mt-3">
              ...
              <li>
                <strong>Para los revisores:</strong> Deberán ser puntuales en el
                tiempo asignado para la evaluación y objetivos. Informar
                inmediatamente si hay intento de plagio o conflicto de intereses.
              </li>
              <li>
                <strong>Para los autores:</strong> Deberán ajustarse a los
                lineamientos de presentación de trabajos que exige la revista.
                Evitar conductas como plagio, autoplagio, manipulación de datos
                o conflicto de intereses.
              </li>
              <li>
                <strong>Penalizaciones:</strong> El comité editorial procede al
                rechazo inmediato si se detecta alguna modalidad de conducta
                inapropiada. Se reserva el derecho de sometimiento a revisión de
                artículos de autores reincidentes.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              La Revista digital Matemática, Educación e Internet ofrece acceso
              abierto a todo su contenido bajo el principio de que al hacer la
              investigación libremente disponible para el público, se favorece
              un mayor intercambio global de conocimientos.
            </p>
            <p className="mt-3">
            ...
            <p className="mt-3">
              De igual forma, todos los artículos de la revista están disponibles
              de forma gratuita inmediatamente después de su publicación, y los
              lectores pueden leer, descargar, copiar, distribuir, imprimir,
              buscar o enlazar los textos de forma parcial o total, y usarlos
              para cualquier otro propósito legal, de acuerdo con la licencia de{" "}
              <a
