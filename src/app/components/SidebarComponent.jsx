          ...
          <>
            <div className="w-full max-w-sm min-w-[200px] px-4 pt-4 space-x-2">
              <div className="relative flex items-center">
                <input
                  class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-black/40 rounded-md pl-3 pr-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
